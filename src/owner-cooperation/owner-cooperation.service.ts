...
export class OwnerCooperationService {
  ...
  create(createOwnerCooperationDto: CreateOwnerCooperationDto) {
    return this.prismaService.ownerCooperation.create({
  ...
  findOne(id: number) {
    return this.prismaService.ownerCooperation.findUnique({
      where: {
        id,
      },
    });
  ...
  update(id: number, updateOwnerCooperationDto: UpdateOwnerCooperationDto) {
    return this.prismaService.ownerCooperation.update({
      where: {
        id,
      },
  ...
  remove(id: number) {
    return this.prismaService.ownerCooperation.delete({
      where: {
        id,
      },
    });
